...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 12, 21, 11);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetAtlasSprite", _m_SetAtlasSprite);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetBgSprite", _m_SetBgSprite);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetAtlasSprite(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _atlasName = LuaAPI.lua_tostring(L, 2);
                    string _spriteName = LuaAPI.lua_tostring(L, 3);
                    
                    gen_to_be_invoked.SetAtlasSprite( _atlasName, _spriteName );
        ...
        static int _m_SetBgSprite(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _bgName = LuaAPI.lua_tostring(L, 2);
                    
                    gen_to_be_invoked.SetBgSprite( _bgName );
                ...
                {
                    string _bgPath = LuaAPI.lua_tostring(L, 2);
                    string _bgName = LuaAPI.lua_tostring(L, 3);
                    
                    gen_to_be_invoked.SetBgSprite( _bgPath, _bgName );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Image.SetBgSprite!");
